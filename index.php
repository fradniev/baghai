			...
			<div class="res-com">
				<a href="residential"><div class="col s12 m5 l3" id="res-image">
					<div class="residential">
						...
						<div class="div-res-com" id="divider"></div>
	...
	<div class="row grid partners center-align valign-wrapper">
		...
		<div class="col s12 part-log-tittle">
			...
			<div style="height: 200px; position: relative;">
				<a class="logos-link" target="_blank" href="http://www.flir.ca/home/"> <img id="flir" class="logos" src="<?php echo get_template_directory_uri() . '/images/logos partnes/flir.png'; ?>"></a>
				<a class="logos-link" target="_blank" href="https://www.cdvi.ca/"><img id="cdvi" class="logos" src="<?php echo get_template_directory_uri() . '/images/logos partnes/cdvi.png'; ?>"></a>
				<a class="logos-link" target="_blank" href="https://www.honeywell.com/"><img id="honey" class="logos" src="<?php echo get_template_directory_uri() . '/images/logos partnes/Honeywell.png'; ?>"></a>
				...
				<div class="col s12">
					<div style="height: 200px; position: relative; left:6%; width: 90%">
						<div class="row valign-wrapper">
							<div class="col s6">
								<a class="logos-link" target="_blank" href="http://www.canasa.org/CANASA"><img id="canasa" class="logos" src="<?php echo get_template_directory_uri() . '/images/logos partnes/canasa.png'; ?>"></a>
							</div>
							<div class="col s6">
								<a class="logos-link" target="_blank" href="http://www.cfaa.ca/"><img id="canada" class="logos" src="<?php echo get_template_directory_uri() . '/images/logos partnes/canada.png'; ?>"></a>
							</div>
						</div>
					</div>
				</div>
